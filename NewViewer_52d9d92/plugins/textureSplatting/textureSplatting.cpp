...
void TextureSplatting::onPluginLoad()
{
    ...
    QString fs_src =
      ...
      "out vec4 fragColor;"
      "void main() {"
      "fragColor =  mix(mix(texture(sampler0, vtexCoord), texture(sampler1, vtexCoord), 0.5),"
      "                 texture(sampler2, vtexCoord), 0.5); }";
	...
	// Load Texture 3
	QString filename3 = QFileDialog::getOpenFileName(0, "Open Image 3", "../../Textures", "Image file (*.png *.jpg)");	
